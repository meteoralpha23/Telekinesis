Shader "Unreal/Metal_IronRusty_Mat"
{
    Properties
    {
		...
		Material_Texture2D_0( "Metal_IronRusty_NRM", 2D ) = "white" {}
		Material_Texture2D_1( "Metal_IronRusty_Diff", 2D ) = "white" {}
		Material_Texture2D_2( "Metal_IronRusty_Rough", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "Metal_IronRusty_Mat.hlsl"
