Shader "Unreal/AmmoBox_Metal_Mat"
{
    Properties
    {
		...
		Material_Texture2D_0( "AmmoBox_Metal_NRM", 2D ) = "white" {}
		Material_Texture2D_1( "AmmoBox_Metal_Diff", 2D ) = "white" {}
		Material_Texture2D_2( "AmmoBox_Metal_Metaliness", 2D ) = "white" {}
		Material_Texture2D_3( "AmmoBox_Metal_Spec", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "AmmoBox_Metal_Mat.hlsl"
