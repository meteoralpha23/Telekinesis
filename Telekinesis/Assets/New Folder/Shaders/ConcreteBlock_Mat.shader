Shader "Unreal/ConcreteBlock_Mat"
{
    Properties
    {
		...
		Material_Texture2D_0( "Normal_Map_from_Mesh_Material__26", 2D ) = "white" {}
		Material_Texture2D_1( "Concrete_01_NRM", 2D ) = "white" {}
		Material_Texture2D_2( "ConcreteBlock_Diff", 2D ) = "white" {}
		Material_Texture2D_3( "Concrtete_Spec", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "ConcreteBlock_Mat.hlsl"
