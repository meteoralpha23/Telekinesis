Shader "Unreal/AmmoBox_Wood_Mat"
{
    Properties
    {
		...
		Material_Texture2D_0( "AmmoBox_Wood_NRM", 2D ) = "white" {}
		Material_Texture2D_1( "AmmoBox_Wood_Diff", 2D ) = "white" {}
		Material_Texture2D_2( "AmmoBox_Wood_Spec", 2D ) = "white" {}
