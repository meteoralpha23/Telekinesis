...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local3 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, samplerMaterial_Texture2D_2,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat3 Local4 = (1.00000000 - Local3.rgb);

	PixelMaterialInputs.EmissiveColor = Local1;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local2.rgb;
	PixelMaterialInputs.Metallic = Local4;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local3.rgb;
