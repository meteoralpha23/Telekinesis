Shader "Unreal/Window_Frame_Small_Inst"
{
    Properties
    {
		...
		Material_Texture2D_0( "NRM", 2D ) = "white" {}
		Material_Texture2D_1( "PBR", 2D ) = "white" {}
		Material_Texture2D_2( "Diff", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "Window_Frame_Small_Inst.hlsl"
